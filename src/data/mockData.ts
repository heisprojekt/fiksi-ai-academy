...
export const MOCK_PROMPTS: PromptPack[] = [
  {
    id: 'prompt-1',
...
export const MOCK_BLOGS: BlogArticle[] = [
  {
    id: 'blog-1',
    title: 'Panduan Lengkap Omni Flash v3: Rahasia Bikin Video Commercial AI Hiper-Realistis',
    slug: 'omni-flash-v3-guide',
    ...
    excerpt: 'Simak trik rahasia menggunakan Omni Flash v3 untuk menjaga konsistensi wajah karakter, pencahayaan alami, dan gerakan kamera yang halus.',
    content: `
      <h2>Mengapa Omni Flash v3 Menjadi Standar Baru Kreator AI</h2>
      <p>Perkembangan teknologi AI generatif video bergerak begitu pesat. Jika dahulu kita kesulitan mempertahankan raut wajah atau bentuk produk dalam scene yang berbeda, kini dengan <strong>Omni Flash v3</strong> kendala tersebut teratasi sepenuhnya.</p>
      
      <h3>1. Mengunci Seed dan Reference Image</h3>
      <p>Langkah pertama yang paling krusial adalah menggunakan image reference dengan pencahayaan netral. Hindari menggunakan gambar dengan bayangan yang terlalu ekstrem agar AI tidak bingung saat merender angle yang berbeda.</p>

      <h3>2. Menyusun Formula Prompt yang Tepat</h3>
      <p>Struktur prompt ideal untuk Omni Flash v3 terdiri dari 4 bagian utama:</p>
      <ul>
        <li><strong>Subject & Action:</strong> Siapa atau apa yang menjadi fokus utama.</li>
        <li><strong>Environment & Context:</strong> Lokasi, waktu, dan suasana latar belakang.</li>
        <li><strong>Lighting & Camera:</strong> Jenis lampu, f-stop, focal length, dan sudut kamera.</li>
        <li><strong>Style & Parameters:</strong> Penunjuk kustom seperti --ar 16:9 atau --stylize.</li>
      </ul>
      
      <h3>Kesimpulan</h3>
      <p>Dengan memadukan prompt yang terstruktur dan aset pendukung dari FIKSI AI Academy, kamu bisa menghasilkan konten kelas dunia hanya dalam hitungan menit.</p>
    `,
    tags: ['Omni Flash', 'AI Video', 'Tutorial', 'Prompting'],
    tableOfContents: [
      { id: 'section-1', title: 'Mengapa Omni Flash v3 Menjadi Standar' },
      { id: 'section-2', title: '1. Mengunci Seed dan Reference' },
      { id: 'section-3', title: '2. Menyusun Formula Prompt' },
      { id: 'section-4', title: 'Kesimpulan' }
    ]
  }
];

export const MOCK_WEEKLY_UPDATES = [
  {
    version: 'v1.8',
    date: '20 Mei 2025',
