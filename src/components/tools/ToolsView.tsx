...
export const ToolsView: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-8 py-4 animate-in fade-in duration-200">
      ...
      {/* Filter & Search Bar */}
      <div className="flex flex-col gap-4 p-4 rounded-3xl bg-[#13151D]/90 border border-white/[0.08] backdrop-blur-xl">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-1.5 p-1 rounded-2xl bg-[#0B0C10] border border-white/10 text-xs w-full sm:w-auto overflow-x-auto">
