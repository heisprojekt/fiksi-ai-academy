        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="relative w-full sm:w-80">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 rounded-2xl bg-[#0B0C10] border border-white/10 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-orange-500/60 focus:ring-1 focus:ring-orange-500/30"
            />
          </div>
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto overflow-x-auto">
            ...
            <div className="flex items-center gap-2 shrink-0">
              <select
                ...
                className="px-3 py-2 rounded-2xl bg-[#0B0C10] border border-white/10 text-xs text-orange-300 font-bold focus:outline-none cursor-pointer"
              >
                {aiModels.map(m => (
                ...
                <button
                  ...
                  className={`px-2.5 py-1 rounded-lg text-[11px] font-medium whitespace-nowrap transition-all flex items-center gap-1 shrink-0 ${
                    selectedSubCategory === sub
                      ? 'bg-orange-500/20 text-orange-300 border border-orange-500/35 shadow-sm font-semibold'
              ...
              <GlassCard key={prompt.id} hoverable className="p-4 flex flex-col justify-between gap-4 group relative overflow-hidden transition-all duration-300">
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-[#08090E] via-transparent to-black/30 p-3 flex flex-col justify-between">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[10px] font-bold text-orange-300 bg-black/60 backdrop-blur-md px-2 py-0.5 rounded-md">
                        {prompt.difficulty}
                      </span>
                    </div>
                  </div>
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex items-center justify-between gap-2">
                    <h3 
                      onClick={() => setActivePromptForModal(prompt)}
                      className="text-base font-bold text-white group-hover:text-orange-300 transition-colors cursor-pointer line-clamp-1"
                    >
                      {prompt.title}
                    </h3>
                  </div>
                  ...
                  <div className="relative rounded-xl overflow-hidden border border-white/[0.06]">
                    ...
                    {isLockedForUser && (
                      ...
                      >
                        <span className="text-[11px] font-bold text-orange-300 flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-orange-500/20 border border-orange-500/40">
                  ...
                  <div className="flex flex-wrap items-center gap-1.5 pt-1">
                    <span className="text-[10px] font-semibold text-orange-300 bg-orange-500/10 border border-orange-500/20 px-2 py-0.5 rounded-md">
                      {prompt.category}
                    </span>
                ...
                <div className="flex items-center gap-2 pt-2 border-t border-white/10">
                  ...
                  {isLockedForUser ? (
                    <button
                      ...
                      className="flex-1 px-3 py-2 rounded-xl bg-orange-500/15 hover:bg-orange-500/25 border border-orange-500/35 text-orange-300 text-xs font-bold flex items-center justify-center gap-1.5 shadow-sm transition-all active:scale-95"
                    >
